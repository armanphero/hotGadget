        ...
        <ul className='items-center hidden space-x-8 lg:flex'>
          ...
          <li>
            <Link to='/cart' aria-label='Cart' title='Cart'>
              <div className='relative py-3 relative'>
                <ShoppingCartIcon className='h-6 w-6 text-cyan-400' />
                <span className='absolute top-1 -right-2'>{productsInDb.length}</span>
              </div>
            </Link>
          </li>
          <li>
                  ...
                  <ul className='space-y-4'>
                    ...
                    <li>
                      ...
                      >
                        <div className='relative py-3 relative'>
                          <ShoppingCartIcon className='h-6 w-6 text-cyan-400' />
                          <span className='absolute top-1 left-6'>{productsInDb.length}</span>
                        </div>
                      </Link>
                    </li>
                    <li>
